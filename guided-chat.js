(function () {
  ...
  function createTopicOptions() {
    return [
      ...
      createOption("מה לגבי מצבים רגישים יותר?", "sensitiveAsk", {
        capture: { topic: "מצבים רגישים" },
        leadIntent: "אם צריך גישה רגישה יותר",
      }),
  ...
  const flows = {
    ...
    sensitiveAsk: {
      messages: () => [
        "יש מצבים שבהם חשוב להיכנס יותר בעדינות ופחות עם שאלות.",
        "מה הכי קרוב למה שחשוב שתדעו שאני אבין?",
      ],
      options: () => [
    ...
    sensitivePhysical: {
      messages: () => [
        ...
        "לא צריך לפרט יותר ממה שנוח לכם.",
      ],
      options: () => createFollowupOptions(),
    ...
    sensitiveMedical: {
      messages: () => [
        ...
        "אין צורך להסביר מעבר למה שנחוץ לכם.",
      ],
      options: () => createFollowupOptions(),
    ...
    sensitivePiled: {
      messages: () => [
        ...
        "פשוט תכתבו לי את זה כמו שזה, ואני אגיד בכנות אם אני יכולה לקחת את זה.",
      ],
      options: () => createFollowupOptions(),
      handoffLabel: "לכתוב לי מה המצב",
    },
